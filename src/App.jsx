...
const t = {
  ...
  ru: {
    ...
    terms: "Условия",
    termsList: [
      "Гибкие объёмы для пилотной партии.",
      "Простые B2B-договоры, помесячная оплата.",
      "Доставка по Парижу за 24–72 часа."
    ],
    contact: "Контакты",
...
const order = ["fr", "en", "ru"];
const nextLang = lang => order[(order.indexOf(lang) + 1) % order.length];
      ...
      <header className="sticky top-0 z-50 backdrop-blur bg-white/80 border-b">
        <div className="max-w-5xl mx-auto px-5 py-3 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            {/* круглый эмблем */}
            <img src="/logo-round.svg" alt="NÉORA emblem" className="h-6 w-auto opacity-80" />
          </div>
          <button
        ...
        <div>
          ...
          >
            ...
            <textarea
              name="msg"
              placeholder={
                lang === "ru" ? "Сообщение (необязательно)" :
                lang === "fr" ? "Message (optionnel)" :
                "Message (optional)"
              }
              className="border rounded-lg px-3 py-2 min-h-[90px]"
            ></textarea>
            <button className="bg-[var(--brand)] text-white font-semibold rounded-lg px-4 py-2 hover:opacity-90 transition">
              {L.cta}
            </button>
      ...
      <section className="max-w-5xl mx-auto px-5 py-10">
        ...
        <div className="mt-3 flex gap-3 flex-wrap">
          <a
            ...
            href="mailto:hello@neora.coffee"
          >
            hello@neora.coffee
          </a>
          <a
